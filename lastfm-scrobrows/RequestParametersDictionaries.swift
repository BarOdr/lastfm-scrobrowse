...
let PARAM_USER = "user"
let PARAM_ARTIST = "artist"
let PARAM_SONG = "song"
let PARAM_ALBUM = "album"
...
let PARAM_DICT_USER_GETTOPARTISTS = [PARAM_USER: "tandetnie", PARAM_PERIOD: PARAM_OVERALL, PARAM_APIKEY: LASTFM_API_KEY, PARAM_METHOD: PARAM_USER_GET_TOP_ARTISTS, PARAM_FORMAT: PARAM_JSON]
